<template>
  <div
    class="card bg-white p-2 p-lg-5 castom-tab"
  >
    <div
      v-for="(item) in items"
      :key="item.id"
        ...
        <b-tab>
          <template #title>
            <feather-icon
              ...
              class="mr-50"
            />
            <span class="d-none d-sm-inline">Опыт работы</span>
          </template>
          <b-card-text>

            <skill-work>
              <template v-slot:companeSkill>
                <p>В сфере IT</p>
              </template>
              <template v-slot:FreelanceSkill>
                <p>Фриланс</p>
              </template>
            </skill-work>
        ...
        <b-tab>
          <template #title>
            <feather-icon
              ...
              class="mr-50"
            />
            <span class="d-none d-sm-inline">Образование</span>
          </template>
          <b-card-text>
            <education-user />
          </b-card-text>
        ...
        <b-tab>
          <template #title>
            <feather-icon
              ...
              class="mr-50"
            />
            <span class="d-none d-sm-inline">Навыки</span>
          </template>
          <b-card-text>
            <skills-user-component />
          </b-card-text>
        </b-tab>
        ...
        <b-tab>
          <template #title>
            <feather-icon
              ...
              class="mr-50"
            />
            <span class="d-none d-sm-inline">Локация и вид занятости</span>
          </template>
          <b-card-text>
